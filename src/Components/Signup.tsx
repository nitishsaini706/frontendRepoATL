...
const Signup: React.FC<Props> = ({setShowSignup,setShowLogin}) => {
  return (
<div className="w-[500px] flex flex-col items-center justify-center bg-[#131319]">
...
<div className="bg-[#27292D] border-2 border-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <div className="text-gray-400 text-start mt-4" onClick={()=>{setShowSignup(false);setShowLogin(true)}}>
